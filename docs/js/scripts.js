...
// универсальная форма
function authForm() {
  var _spread, _spread2, _spread3, _spread4, _spread5;
  ...
  var reset_form = {
    login: {
      value: "",
      error: false,
      spread: (_spread3 = {}, _defineProperty(_spread3, "@input", function input() {
        this.cleanErrors();
      }), _defineProperty(_spread3, "@paste", function paste() {
        this.cleanErrors();
      }), _defineProperty(_spread3, ":class", function _class() {
        return this.fields.login.error ? "border-red-70" : "border-gray-40";
      }), _spread3),
      validate: function validate(that) {
        return that.fields.login.value.length === 0;
    ...
    password_new: {
      value: "",
      error: false,
      spread: (_spread4 = {}, _defineProperty(_spread4, "@input", function input() {
        this.cleanErrors();
      }), _defineProperty(_spread4, "@paste", function paste() {
        this.cleanErrors();
      }), _defineProperty(_spread4, ":class", function _class() {
        return this.fields.password_new.error ? "border-red-70" : "border-gray-40";
      }), _defineProperty(_spread4, ":type", function type() {
        return this.show ? "text" : "password";
      }), _spread4),
      validate: function validate(that) {
    ...
    password_confirm: {
      value: "",
      error: false,
      spread: (_spread5 = {}, _defineProperty(_spread5, "@input", function input() {
        this.cleanErrors();
      }), _defineProperty(_spread5, "@paste", function paste() {
        this.cleanErrors();
      }), _defineProperty(_spread5, ":class", function _class() {
        return this.fields.password_confirm.error ? "border-red-70" : "border-gray-40";
      }), _defineProperty(_spread5, ":type", function type() {
        return this.show ? "text" : "password";
      }), _spread5),
      validate: function validate(that) {
        return that.fields.password_confirm.value.length < MIN_PASSWORD_LENGTH || that.fields.password_confirm.value !== that.fields.password_new.value;
      }
    }
  };
  return {
    ...
    send: function () {
      var _send = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var field, action, fields, _field, data, response, res;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.t0 = _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().keys(this.fields);
              ...
              case 7:
                action = this.$el.name.split("_")[0];
                fields = {};

                for (_field in this.fields) {
                  fields[_field] = this.fields[_field]['value'];
                }
...
document.addEventListener("click", function (e) {
  ...
  var contact = e.target.dataset.dContact || e.target.closest("[data-d-contact]").dataset.dContact; // todo
